...
urlpatterns += [
    ...
    path('api/collections/<int:pk>/', api.view_collection, name='api-view-collection'),
    path('api/collections/<int:pk>/update/', api.update_collection, name='api-update-collection'),
    path('api/collections/<int:pk>/delete/', api.delete_collection, name='api-delete-collection'),
    # Construct paths
    ...
    path('api/constructs/<int:pk>/', api.view_construct, name='api-view-construct'),
    path('api/constructs/<int:pk>/update/', api.update_construct, name='api-update-construct'),
    path('api/constructs/<int:pk>/delete/', api.delete_construct, name='api-delete-construct'),
    # Effect paths
    ...
    path('api/effects/<int:pk>/', api.view_effect, name='api-view-effect'),
    path('api/effects/<int:pk>/update/', api.update_effect, name='api-update-effect'),
    path('api/effects/<int:pk>/delete/', api.delete_effect, name='api-delete-effect'),
    # Hypothesis paths
    ...
    path('api/hypotheses/<int:pk>/', api.view_hypothesis, name='api-view-hypothesis'),
    path('api/hypotheses/<int:pk>/update/', api.update_hypothesis, name='api-update-hypothesis'),
    path('api/hypotheses/<int:pk>/delete/', api.delete_hypothesis, name='api-delete-hypothesis'),
    # Journal paths
    ...
    path('api/journals/<int:pk>/', api.view_journal, name='api-view-journal'),
    path('api/journals/<int:pk>/update/', api.update_journal, name='api-update-journal'),
    path('api/journals/<int:pk>/delete/', api.delete_journal, name='api-delete-journal'),
    # Key figure paths
    ...
    path('api/methods/<int:pk>/', api.view_method, name='api-view-method'),
    path('api/methods/<int:pk>/update/', api.update_method, name='api-update-method'),
    path('api/methods/<int:pk>/delete/', api.delete_method, name='api-delete-method'),
    ...
    path('api/statistical_results/<int:pk>/', api.view_statistical_result, name='api-view-statistical-result'),
    path('api/statistical_results/<int:pk>/update/', api.update_statistical_result, name='api-update-statistical-result'),
    path('api/statistical_results/<int:pk>/delete/', api.delete_statistical_result, name='api-delete-statistical-result'),
    # Study paths
    path('api/studies/', api.list_studies, name='api-list-studies'),
    path('api/studies/create/', api.create_study, name='api-create-study'),
    path('api/studies/<int:pk>/', api.view_study, name='api-view-study'),
    path('api/studies/<int:pk>/update/', api.update_study, name='api-update-study'),
    path('api/studies/<int:pk>/delete/', api.delete_study, name='api-delete-study'),
    # Transparency paths
    ...
    path('api/transparencies/<int:pk>/', api.view_transparency, name='api-view-transparency'),
    path('api/transparencies/<int:pk>/update/', api.update_author, name='api-update-author'),
    path('api/transparencies/<int:pk>/delete/', api.delete_author, name='api-delete-author'),
]
