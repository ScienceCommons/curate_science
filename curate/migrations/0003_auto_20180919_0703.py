...
from curate.models import Article, Author, Journal, ArticleAuthor, RelatedArticle, Study, Effect, Collection, Construct, Hypothesis, KeyFigure, StatisticalResult, Method, VariableRelationship, Transparency
...
def seed_data(apps, schema_editor):
    ...
    # VariableRelationship = apps.get_model('curate', 'Method')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('curate', '0002_auto_20180917_0527'),
    ]
